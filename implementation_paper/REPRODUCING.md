...
`registry.codeocean.com/published/cb1169eb-50f3-4a02-98bf-1dd543af0363:v1`
...
docker run --platform linux/amd64 --rm --gpus all \
  ...
  registry.codeocean.com/published/cb1169eb-50f3-4a02-98bf-1dd543af0363:v1 bash run
```
